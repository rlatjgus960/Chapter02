...
public class ShapeApp {
	...
	public static void main(String[] args) {
		...
		*/
		...
		rArray[1] = new Rectangle("주황", "검정",4,4);
		rArray[2] = new Rectangle("초록", "검정",3,3);
		...
		*/
		...
		cArray[0] = new Circle("빨강", "검정",3);
		cArray[1] = new Circle("노랑", "검정",4);
		cArray[2] = new Circle("파랑", "검정",5);
		...
		*/
		...
		tArray[0] = new Triangle("초록", "검정",3,3);
		tArray[1] = new Triangle("보라", "검정",4,4);
		tArray[2] = new Triangle("빨강", "검정",5,5);
